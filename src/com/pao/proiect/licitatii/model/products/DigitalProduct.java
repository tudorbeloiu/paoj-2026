...
public class DigitalProduct extends Product{
    ...
    private static final List<String> availableFormats = List.of("EXE","MP3", "MP4", "PDF", "XML", "JSON", "ZIP", "RAR", "GZ", "APK", "PNG", "JPG", "ISO");
    ...
    public DigitalProduct(String id, String name, String description, double price, Category category, String format, String license){
