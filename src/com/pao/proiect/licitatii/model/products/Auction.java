...
public class Auction {
    ...
    public Auction(String id, Seller seller, Product product, double startingPrice,
                   double currentPrice, LocalDateTime startingTime, LocalDateTime endingTime,
                   AuctionType auctionType, AuctionStatus auctionStatus) {
        this.id = id;
        this.startingPrice = startingPrice;
